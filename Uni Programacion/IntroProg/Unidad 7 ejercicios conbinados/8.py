...
while continuar == 1:
    ...
    elif cantidad_alumnos_M < cantidad_alumnos_B:
        carrera_mayor = "Licenciatura en Informatica."
    elif cantidad_alumnos_M < cantidad_alumnos_C:
...
'''
    # Eleccion de la carrera con mayor cantidad de cantidad de alumnos
    if cantidad_alumnos_A > cantidad_alumnos_B and cantidad_alumnos_C:
        cantidad_alumnos_Max =+ 1
    elif cantidad_alumnos_B > cantidad_alumnos_A and cantidad_alumnos_C:
        cantidad_alumnos_Max =+ 1
    elif cantidad_alumnos_C > cantidad_alumnos_A and cantidad_alumnos_B:
        cantidad_alumnos_Max = cantidad_alumnos_Max + 1
    ...
    # Eleccion de la carrera con mmenor cantidad de cantidad de alumnos
    if cantidad_alumnos_A < cantidad_alumnos_B and cantidad_alumnos_C:
        cantidad_alumnos_min = cantidad_alumnos_A
    if cantidad_alumnos_B < cantidad_alumnos_A and cantidad_alumnos_C:
        cantidad_alumnos_min = cantidad_alumnos_B
    if cantidad_alumnos_C < cantidad_alumnos_A and cantidad_alumnos_B:
        cantidad_alumnos_min = cantidad_alumnos_C

    if cantidad_alumnos_min == cantidad_alumnos_A:
        carrera_menor = "Licenciatura en Gestión Operativa de Construcciones Inteligentes."
    if cantidad_alumnos_min == cantidad_alumnos_B:
        carrera_menor = "Licenciatura en Informatica."
    if cantidad_alumnos_min == cantidad_alumnos_C:
        carrera_menor = "Licenciatura en Economia."
'''
